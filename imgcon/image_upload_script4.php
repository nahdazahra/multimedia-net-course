...
include_once("ak_php_img_lib_1.04.php");
...
if (strtolower($fileExt) != "wbmp") {
    $target_file = "uploads/resized_$fileName";
    $new_wbmp = "uploads/resized_".$kaboom[0].".wbmp";
    ak_img_convert_to_wbmp($target_file, $new_wbmp, $fileExt);
}
